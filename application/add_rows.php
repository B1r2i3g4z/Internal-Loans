...
echo '<br>';
echo'<span class="itext" style="background-color: green">Unable to Add Row.....Please try again later!</span>';
}
else{
echo '<meta http-equiv="refresh" content="2;url=updateloans.php?id='.$id.'">';
echo '<br>';
echo'<span class="itext" style="background-color: green">Adding Row.....Please Wait!</span>';
}
}
?>
</div>

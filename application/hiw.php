    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
	       <?php 
			...
			?>
      <ul class="sidebar-menu" style="backround-color: red !important">
        <li class="header" style="color: red !important">MAIN NAVIGATION</li>
		<li><a href="dashboard.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-dashboard"></i> <span>Dashbord</span></a></li>
		
		<li class="treeview ">
          <a href="#">
            <i class="fa fa-book"></i> <span>Email</span>
	...
	<li><a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-book"></i> <span>My Wallet</span></a></li>
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
			...
			<li class="active"><a href="hiw.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>How System Works</a></li>
...
<?php }}?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-gear"></i>&nbsp;How System Works
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> <a href="hiw.php?id=<?php echo $_SESSION['tid']; ?>">How System Works</a></li>
	...
	<div class="box">
	       ...
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-gear"></i> How System Works Setup</h3>
            </div>
             <div class="box-body">
 
              
			  <?php
$se = mysqli_query($link, "SELECT * FROM hiw") or die (mysqli_error($link));
...
?>
 <form action="edit_hiw.php" method="post" enctype="multipart/form-data">
 <div class="form-group">
 <label for="inputName" class="col-sm-2 control-label">How it works:</label>
 <div class="col-sm-10">
 <textarea name="hiw" id="editor1" cols="100" rows="5" required><?php echo $hiw; ?></textarea>
 </div>
 </div>
 <div class="form-group">

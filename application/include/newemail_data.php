<div class="box">
            ...
            <h3 class="panel-title" style="font-size:25px; font-weight:bold; color:#00b259;"><i class="fa fa-mail-reply-all"></i> New Email</h3>
            </div>
             <div class="box-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data">
				 <?php echo '<div class="alert" style="background-color: #e0bf7e; color:white;" >
			  <a href = "#" class = "close" data-dismiss= alert"  style="background-color: #e0bf7e; color:white;"> &times;</a>
  				<strong>Note that&nbsp;</strong> &nbsp;&nbsp;Some Fields are Rquired.
				</div>'?>
              	<div class="box-body">
				
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#00b259; font-weight:bold; font-size:18px">Select Receiver</label>
                  <div class="col-sm-10">
				...
				<div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:  #00b259; font-weight:bold; font-size:18px">Subject: </label>
                  	<div class="col-sm-10">
					...
					<div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#00b259; font-weight:bold; font-size:18px">Message</label>
                  	<div class="col-sm-10">
              ...
              <div class="box-footer">
                				<button type="reset" class="btn btn-primary btn-flat" style="background-color: #e0bf7e; font-size:18px"><i class="fa fa-times">&nbsp;Reset</i></button>
                				<button name="send" type="submit" class="btn btn-success btn-flat"><i class="fa fa-upload" style="font-size:18px">&nbsp;Send</i></button>
              </div>
			  </div>
<?php							
if (isset($_POST['send']))

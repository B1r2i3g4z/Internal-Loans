...
<form method="post">
			 <a href="dashboard.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("401"); ?>"><button type="button" class="btn btn-flat btn-warning"  style="background-color:#e0bf7e; font-size:18px; border-color:white;font-size:18px; font-weight:bold; color:#white;"#00b259><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> 
<?php
...
?>
	<?php echo ($pdelete == '1') ? '<button type="submit" class="btn btn-flat btn-danger" name="delete"  style="background-color:red; font-size:18px; border-color:white;font-size:18px; font-weight:bold; color:#white;"><i class="fa fa-times"></i>&nbsp;Multiple Delete</button>' : ''; ?>
	<?php echo ($pcreate == '1') ? '<a href="newloans.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("405").'"><button type="button" class="btn btn-flat btn-success"  style="background-color:#00b259;border-color:white;font-size:18px; font-weight:bold; color:#white;"><i class="fa fa-plus"></i>&nbsp;Add Loans</button></a>' : ''; ?>
<?php
...
?>
	<button type="button" class="btn btn-flat btn-danger"  style="background-color:#e0bf7e;border-color:white;font-size:18px; font-weight:bold; color:#white;"><i class="fa fa-times"></i>&nbsp;Overdue:&nbsp;<?php echo number_format($num,0,'.',','); ?></button>
	
	<a href="printloan.php" target="_blank" class="btn btn-info btn-flat"  style="background-color:#00b259; font-size:20px; border-color:white;font-size:18px; font-weight:bold; color:#white;"><i class="fa fa-print"></i>&nbsp;Print</a>
	<a href="exportloan.php" target="_blank" class="btn btn-success btn-flat"  style="background-color:#e0bf7e;border-color:white;font-size:18px; font-weight:bold; color:#white;"><i class="fa fa-send"></i>&nbsp;Export Excel</a>
...
$selectin = mysqli_query($link, "SELECT * FROM borrowers WHERE id = 'tid'") or die (mysqli_error($link));

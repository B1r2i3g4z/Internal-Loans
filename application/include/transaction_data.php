...
?>
				...
				<td><?php echo $dt; ?></td>
				<td align="center"><a href="#myModal <?php echo $id; ?>"> <button type="button" class="btn btn-primary btn-flat" data-target="#myModal<?php echo $id; ?>" data-toggle="modal" style="background-color:#e0bf7e; border-color:white;"><i class="fa fa-print"></i> Receipt</button></a></td>
				</tr>
<?php } } ?>
             </tbody>
                </table>  
...
?>			
			...
			<div class="box box-info" style="border-color:#e0bf7e;">
            <div class="box-body">
            <div class="alert" align="center" class="style2" style="background-color:#00b259; color:white; font-size:20px;";>NUMBER OF TRANSACTION:&nbsp;
			<?php 

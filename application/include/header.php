...
if($day == $datein)
{
include("alert_sender/sms_charges.php");
}
else{
	//empty action
}
...
var chart2 = AmCharts.makeChart( "chartdiv2", {
  ...
  "dataProvider": [ {
    ...
    "title": "Total Amount Deposit",
    "value": 
<?php
	$add=mysqli_query($link,'SELECT SUM(amount) from transaction WHERE t_type = "Deposit"');
  	while($row2= mysqli_fetch_array($add))
  	{

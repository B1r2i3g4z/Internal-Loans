...
?>
		<div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green" style="background-color: #00b25a !important">
            <div class="inner">
...
?>
		<div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-aqua" style="background-color: #00b25a !important">
            <div class="inner">
...
?>	
		   <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-yellow" style="background-color: #00b25a !important">
            <div class="inner">
...
?>
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-red" style="background-color: #00b25a !important">
            <div class="inner">
...
{
?>
          <div class="box-body" style="color: #00b25a" !important>
    <div class="alert alert-info" align="center" class="style2" style="background-color: #00b25a !important">LOAN INFORMATION CHART</div>
    <div id="chartdiv"></div>
</div>             
			</div>
<?php

<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title" style="color: #00b259; font-weight:bold; font-size:25px"><i class="fa fa-user"></i> Customer Withdrawal Form</h3>
            </div>
             <div class="box-body">
            
			 <form class="form-horizontal" method="post" enctype="multipart/form-data">
			  <?php echo '<div class="alert alert-info fade in" style="background-color: #e0bf7e; color:white; font-weight:bold; font-size:13px">
...
<?php } ?>
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:  #00b259; font-weight:bold; font-size:18px">Amount to Withdraw</label>
                  <div class="col-sm-10">
              ...
              <div class="box-footer">
                				...
                				<button name="save" type="submit" class="btn btn-success btn-flat" style="background-color:#00b259;border-color:white;  font-weight:bold; font-size:18px"><i class="fa fa-save">&nbsp;Make Withdrawal</i></button>
